    ...
    <div class="container">
        <?php 
            if(isset($_SESSION['moderator_login']))
            {
                ...
                $stmt = $conn->query("SELECT * FROM acc_detail WHERE detail_id = $moderator_id");
                $stmt-> execute();
        ...
        <div class="container mt-5">
            <h1 class="text-white">Welcome Moderator: <?php echo $row['firstname'].' '.$row['lastname']?></h1>
                ...
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/mod_analysis/" class="btn btn-warning">View</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/mod_table/" class="btn btn-warning">View</a>
                        </div>
                    </div>
                </div>
            </div>
