    ...
    else
    {
        try
        {
            ...
            else
            {
                ...
                $insertHistoryStmt = $conn->prepare("INSERT INTO history (id, old_balance, new_balance, difference, ref_id) VALUES (:user_id, :current_balance, :new_balance, :money, 'withdraw')");
